                ...
                if (deviceData.devices == undefined) {
                    ...
                    if (TABLO_DEVICE) {
                        ...
                        if (device) {
                            ...
                            // Fallback to selection or exit? 
                            // If the user specified a device, they probably want that one.
                            // But for safety, let's fall back to selection so they are not stuck.
